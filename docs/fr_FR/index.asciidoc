...
=== Présentation
Ce plugin permet de récupérer des informations des cartes ozw672.01.
Le serveur Web OZW672... permet la télégestion d'installations via internet et une application pour Smartphone. Il permet le raccordement d'un appareil LPB/BSB.
...
image::../images/ozw6721.png[align="center"]
image::../images/ozw672_screenshot2.png[align="center"]
